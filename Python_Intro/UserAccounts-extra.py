class User:
	...
	def add_account(self, accountid=1, int_rate=0.02, balance=0):
		self.account.add_newaccount(accountid, int_rate, balance)
...
class BankAccount:
	def __init__(self, accountid=1, int_rate=0.02, balance=0): #Create multiple checking or savings for same user? Unique identifier?
		...
		self.accountlist.append([accountid, int_rate, balance]) #create new list for each account within accountlist
	...
	def add_newaccount(self,accountid, int_rate, balance):
		self.accountlist.append([accountid, int_rate, balance])
